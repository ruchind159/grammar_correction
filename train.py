...
if __name__ == '__main__':
    ...
    ##for training pre-trained models these arguments are must
    # !python train.py --n_epoch 3 
    # (the train and dev set is obtained after preprocessing parallel files with preprocess_data.py file)
    # --train_set path_to_train_set 
    # --dev_set path_to_dev_set 
    # --model_dir path_to_model 
    # --vocab_path original_vocab_path 
    # --pretrain_folder folder of pretrained model 
